            ...
            <div class="card">
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="national_code">@lang('global.national_code')</label>

                            <div>
                                <input type="text" class="form-control{{ $errors->has('national_code') ? ' is-invalid' : '' }}" name="national_code" id="national_code" value="{{ old('national_code') }}">
